...
def get_grounding_requirement(task: str, task_id: str = None) -> dict:
    ...
    sys_prompt = (
        ...
        "Determine if the task is FACTUAL, GENERATIVE, or HYBRID:\n"
        "- GENERATIVE: Can be answered using internal knowledge (essays, code, general explanations, story writing).\n"
        "- FACTUAL: Requires specific external data points (weather, real-time sports, news, live prices).\n"
        "- HYBRID: Requires a mix of reasoning/internal knowledge + external data lookup.\n\n"
        "Output MUST be a strict JSON object:\n"
        "{\n"
        "  \"required_grounding\": \"NONE\" | \"ARCHIVAL\" | \"RECENT\" | \"REAL_TIME\",\n"
        "  \"task_nature\": \"GENERATIVE\" | \"FACTUAL\" | \"HYBRID\",\n"
        ...
        "- RECENT: For events in the last week or month.\n"
        "- ARCHIVAL: For historical facts or specific research papers.\n"
        "- NONE: For static logic, math, creative writing, or stable general knowledge explanations."
    )
